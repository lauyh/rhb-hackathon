...
const Popup = ({ closePopup }) => (
  <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
    <div
      className="absolute top-0 left-0 bg-gray-700 opacity-40 w-full h-full z-10"
      onClick={closePopup}
    />
    <div className="relative w-[calc(100%-32px)] bg-white border-2 rounded-2xl border-slate-400 px-4 py-12 z-10">
      <XCircleIcon
        ...
        onClick={closePopup}
      />
      <h1 className="font-sans text-xl font-medium text-gray-700">
        Welcome to your House Simulator
      </h1>
      <p className="mt-4">
        In this game, you will be able to build the house of your dreams.
      </p>
      <p className="mt-2">
        You will be guided to earn by working and helping others. Not just that,
        you will also expand your knowledge with the articles and quizzes we
        have available for you, so that you can spend wisely, earn and save!
      </p>
      <p className="mt-2">
        Now now.. not everything will be smooth sailing, as we all know life can
        be challenge but not to worry! We will help you to be prepared for every
        situation.
      </p>
...
const Home = () => {
  ...
  const titleHouse =
    progress == 7 ? "Your Dream House is Built!" : "Build your Dream House";
      ...
      <div className="relative bg-slate-50 h-[calc(100%-66px)]">
        {progressWork ? (
          ...
          <div className="p-4">
            ...
            <div className="bg-white shadow-lg shadow-gray-400 rounded-b-md">
              ...
              <div className="p-4">
                ...
                <p className="mb-6">
                  Help out the family by washing the dishes after family meal!
                </p>
              ...
              <>
                <div className="bg-white shadow-lg shadow-gray-400 rounded-b-md">
                  ...
                  <div className="p-4">
                    ...
                    <p className="mb-2 text-sm">
                      Whether you&apos;re looking to save more money, invest
                      better, or manage your finances more effectively in 2023,
                      it all starts with your daily habits.
                    </p>
                    <p className="mb-2 text-sm">
                      As James Clear said in Atomic Habits:
                      <br />
                      “Your habits have a powerful effect on your life. They can
                      be the difference between success and failure. They can
                      determine whether you are healthy or unhealthy, wealthy or
                      broke.” To help you build better daily financial habits,
                      we&apos;ll go over five practical habit-building methods
                      from Atomic Habits.
                    </p>
                    <div
          ...
          <>
            ...
            {menuPopup && (
              <PurchaseMenu {...{ toggleMenuPopup, handleAddItem }} />
            )}
            <AccBalCard
              netWorth={textNW}
              cashIn={textCashIn}
